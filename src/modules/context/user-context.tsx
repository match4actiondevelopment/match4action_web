import React, { createContext, Dispatch, PropsWithChildren, SetStateAction, useEffect, useMemo, useRef, useState } from "react";
...
const UserProvider: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  const isLogged = useMemo(() => user && Object.keys(user).length > 0 ? true : false, [user]);
