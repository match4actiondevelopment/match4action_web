...
const HeaderButton = dynamic(() => import('../HeaderButton').then((doc) => doc.HeaderButton), {
  ssr: false,
});
...
export const HeaderDesktop = () => {
  return (
    ...
    >
      ...
      <Box component="nav" aria-label="main mailbox folders" padding={0} zIndex={1}>
        <List
          sx={(theme) => ({
            display: 'flex',
            padding: 0,
        ...
        >
          <ListItem sx={{ padding: 0, minInlineSize: 'fit-content' }}>
            <NextLink href="#" style={{ textDecoration: 'none', color: '#fff' }}>
          ...
          <ListItem sx={{ padding: 0, minInlineSize: 'fit-content', color: '#fff' }}>
            <HeaderButton />
          </ListItem>
        </List>
      </Box>
